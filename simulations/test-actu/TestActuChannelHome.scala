...
class TestActuChannelHome extends Simulation {
  ...
  val scn = scenario("test-actu-channel-home-mediacom").group("page") {
    exec(http("test-actu-channel-home-mediacom").get("/search/mediacom/")
  )}
