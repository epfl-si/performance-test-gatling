...
class StagingActuChannelHome extends Simulation {
  ...
  val scn = scenario("staging-actu-channel-home-mediacom").group("page") {
    exec(http("staging-actu-channel-home-mediacom").get("/search/mediacom/")
  )}
