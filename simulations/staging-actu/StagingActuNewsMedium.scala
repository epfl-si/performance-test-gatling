...
class StagingActuNewsMedium extends Simulation {
  ...
  val scn = scenario("staging-actu-news-medium").group("page") {
    exec(http("staging-actu-news-medium").get("/news/des-connexions-se-creent-pour-depasser-la-paralysi/")
  )}
