...
class ActuNewsHeavy extends Simulation {
  ...
  val scn = scenario("actu-news-heavy").group("page") {
    exec(http("actu-news-heavy").get("/news/high-school-students-try-out-an-epfl-chemistry-lab/")
  )}
